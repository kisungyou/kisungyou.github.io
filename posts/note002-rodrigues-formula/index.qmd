...
$$ {#eq-legendre}
and an explicit, compact expression for the polynomials is by Rodrigues' formula
$$
P_n (x) = \frac{1}{2^n n!} \frac{d^n}{dx^n} (x^2-1)^n.
$$ {#eq-rodrigues}

This means that when $P_n (x)$ is plugged in the position of $y$ for @eq-legendre, it must satisfy the equality to 0. In this note, we show indeed the expression of @eq-rodrigues  works, after a bit of tedious arithmetics. 
...
## Part 1. $f_n^{(n)} (x)$ is one solution.
