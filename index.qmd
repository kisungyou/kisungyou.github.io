...
I am an assistant professor in the Department of Mathematics at [Baruch College](https://www.baruch.cuny.edu/) and at [The Graduate Center](https://www.gc.cuny.edu/), both part of the [City University of New York](https://www.cuny.edu/).  My research integrates tools from statistics, differential geometry, and computational mathematics to develop new methods for complex scientific problems, with a strong focus on biomedical data analysis. I am also passionate about high‑performance computing and open‑source software development, aiming to make advanced methods practically accessible across disciplines.
