...
```{=html}
<ul class='list-group list-group-flush'><li class='list-group-item'><div class='grid'><div class='g-col-12 g-col-sm-4'><img src='/images/templates/no-image-yet.png' class='img-fluid'></div><div class='g-col-12 g-col-sm-8'><b>Assessing the Usability of GutGPT: A Simulation Study of an AI Clinical Decision Support System for Gastrointestinal Bleeding Risk</b><br> Colleen Chan, <strong>KY</strong>, Sunny Chung, Mauro Giuffrè, Theo Saarinen, Niroop Rajashekar, Yuan Pu, Yeo Eun Shin, Loren Laine, Ambrose Wong, René Kizilcec, Jasjeet Sekhon, and Dennis Shung (2023).<br><a class="btn btn-outline-dark btn-sm", href="https://arxiv.org/abs/2312.10072" target="_blank" rel="noopener noreferrer">
    <i class="bi bi-file-earmark-pdf" role='img' aria-label='arXiv'></i>
    arXiv
  </a></div></div></li>
