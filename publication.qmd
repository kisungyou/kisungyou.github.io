...
# --- Load YAML data directly ---

with open("list_publication.yaml") as f:
  yaml_data = yaml.safe_load(f)

# --- Count how many published and preprint entries ---
...
msg = (
"The list below includes my "
f"[published](#published) {plural(n_pubs, 'article')} (count: {n_pubs}) "
"and "
f"[preprints](#preprints) {plural(n_wps, 'manuscript', 'manuscripts')} (count: {n_wps}) "
f"in reverse chronological order as of {today_str}."
)
...
for year in sorted(pub_strs["pubs"].keys(), reverse=True):
  display(Markdown(f"### {year} {{#pub-{year}}}"))
  display(HTML(
